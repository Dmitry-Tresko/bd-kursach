...
},{}],"C:/Users/user/AppData/Roaming/npm/node_modules/parcel/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"C:/Users/user/AppData/Roaming/npm/node_modules/parcel/node_modules/process/browser.js"}],"node_modules/toastr/toastr.js":[function(require,module,exports) {
var define;
/*
 * Toastr
 * Copyright 2012-2015
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"createTable.js":[function(require,module,exports) {
"use strict";
...
function createTable(arr, fields) {
  var table = document.createElement('table');
  var outputBlock = document.querySelector('.search__output-result');
  var container = document.querySelector('.search__result-table');
...
},{}],"search-info.js":[function(require,module,exports) {
"use strict";
...
var getInfoBtns = document.querySelectorAll('.search__info-btn');
var getToursByTypeSelect = document.querySelector('#tour-type-selection');
var getToursByFoodSelect = document.querySelector('#tour-food-selection');
var getToursByTourOperatorSelect = document.querySelector('#tour-to-selection');
var deleteBtns = document.querySelectorAll('.search__delete-btn');
var addBtns = document.querySelectorAll('.search__add-btn');
var managerOptions = document.querySelector('.search__manager-options');
...
getInfoBtns.forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    var url = "http://localhost:5000/".concat(event.target.dataset.infoType);
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
        ...
        (0, _createTable.createTable)(data.rows, fields);
      }
    };
...
getToursByTypeSelect.addEventListener('change', function () {
  var tourTypeSelection = getToursByTypeSelect.value;
  var url = "http://localhost:5000/tours/".concat(tourTypeSelection);
  xhr.open('GET', url, true);

  xhr.onreadystatechange = function () {
    if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
      var data = JSON.parse(xhr.responseText);
      var fields = ['Tour ID', 'Type', 'Country', 'Resort', 'Hotel', 'Tour Operator', 'Visa +/-', 'Insurance +/-', 'Food +/-', 'Price', 'Tour operator ID', 'Transport type ID'];
      (0, _createTable.createTable)(data.rows, fields);
    }
  };
...
getToursByFoodSelect.addEventListener('change', function () {
  var tourFoodSelection = getToursByFoodSelect.value;
  var url = "http://localhost:5000/tours/food/".concat(tourFoodSelection);
  xhr.open('GET', url, true);
...
getToursByTourOperatorSelect.addEventListener('change', function () {
  var tourOperatorSelection = getToursByTourOperatorSelect.value;
  var tourOperatorID;

  for (var key in tourOperators) {
    if (tourOperators[key] === tourOperatorSelection) {
      tourOperatorID = key;
    }
  }

  var url = "http://localhost:5000/tours/id/".concat(tourOperatorID);
  xhr.open('GET', url, true);
...
deleteBtns.forEach(function (btn) {
  btn.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      var id, isOk, url, data;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              id = prompt("Enter ID of instance of ".concat(event.target.dataset.instance, ":"), 1);
              ...
              isOk = confirm('Are you sure that you want to delete selected subject?');
              ...
              url = "http://localhost:5000/".concat(event.target.dataset.instance, "/").concat(id);
              _context.prev = 5;
              _context.next = 8;
              return fetch(url, {
                method: 'DELETE'
            ...
            case 8:
              ...
              if (data.status === 200) {
                _toastr.default.success("Instance successfully deleted!");
              } else {
                _toastr.default.error('Error while deleting data!');
              }
...
},{"core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","toastr":"node_modules/toastr/toastr.js","./createTable":"createTable.js"}],"C:/Users/user/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/user/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","search-info.js"], null)
//# sourceMappingURL=/search-info.640c9d52.js.map